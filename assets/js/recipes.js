...
const cocktailsArr = [
  ...
  },
  {
    ...
    overlayText: "Renshen™ Spirit ginseng vodka, red beet juice, maple syrup, lemon juice",
  },
  {
    ...
    overlayText: "Renshen™ Spirit ginseng vodka, dry vermouth, lemongrass, fresh ginger, ginger syrup, ginger beer",
  },
];
...
cocktailsArr.forEach((arr) => {
  ...
  <div class="card" onmouseover="overlayActive(this)" onmouseout="overlayInactive(this)" style="min-width: 300px; margin-left: 4%; margin-right: 4%; overflow: hidden">
    <div id="overlay" class="d-none" style="cursor: pointer"> 
      <div class="d-flex justify-content-center align-items-center" style="width: 100%; height: 79.5%; position: absolute; background-color: rgba(255, 0, 0, 0.4);">
...
const foodArr = [
  {
    src: "https://assets.epicurious.com/photos/5761d0d88accf290434553ab/6:4/w_620%2Ch_413/classic-potato-pancakes.jpg",
    alt: "card image cap",
    text: "Potato Pancakes",
    overlayText: "russet potatoes, onion, egg, all-purpose flour, butter",
  },
  {
    src: "https://static01.nyt.com/images/2017/07/19/dining/26HOT1/19HOT1-articleLarge.jpg",
    alt: "card image cap",
    text: "Ginseng Chicken Soup",
    overlayText: "Renshen™ Spirit ginseng vodka,...",
  },
  {
    src: "https://images.unsplash.com/photo-1512838243191-e81e8f66f1fd?ixid=MXwxMjA3fDB8MHxzZWFyY2h8MXx8ZmlzaCUyMHRhY29zfGVufDB8fDB8&ixlib=rb-1.2.1&auto=format&fit=crop&w=600&q=60",
    alt: "card image cap",
    text: "Perfect Fish Tacos",
    overlayText: "corn torillas, cod, avocado, shredded purple cabbage, jalapeo",
  },
];
